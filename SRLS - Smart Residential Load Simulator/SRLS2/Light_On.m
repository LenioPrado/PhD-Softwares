...
Time_morning =  block.InputPort(1).Data; 
hrs_morning  =  block.InputPort(2).Data;

Time_night   =  block.InputPort(3).Data; 
hrs_night    =  block.InputPort(4).Data; 

clock        =  block.InputPort(5).Data; 

% switchedOn_Mor >= clock  ||  (switchedOn_Mor+TOU_Mor) <= clock &&...
