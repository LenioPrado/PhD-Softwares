function varargout = ONOFF_OPDecisions(varargin)
% ONOFF_OPDECISIONS M-file for ONOFF_OPDecisions.fig
%      ONOFF_OPDECISIONS, by itself, creates a new ONOFF_OPDECISIONS or raises the existing
%      singleton*.
%
%      H = ONOFF_OPDECISIONS returns the handle to a new ONOFF_OPDECISIONS or the handle to
%      the existing singleton*.
%
%      ONOFF_OPDECISIONS('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ONOFF_OPDECISIONS.M with the given input arguments.
%
%      ONOFF_OPDECISIONS('Property','Value',...) creates a new ONOFF_OPDECISIONS or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before ONOFF_OPDecisions_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to ONOFF_OPDecisions_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help ONOFF_OPDecisions

% Last Modified by GUIDE v2.5 28-Apr-2012 08:56:45

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @ONOFF_OPDecisions_OpeningFcn, ...
                   'gui_OutputFcn',  @ONOFF_OPDecisions_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before ONOFF_OPDecisions is made visible.
function ONOFF_OPDecisions_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to ONOFF_OPDecisions (see VARARGIN)

% Choose default command line output for ONOFF_OPDecisions
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes ONOFF_OPDecisions wait for user response (see UIRESUME)
...
if EveryOP==1
    text27  = {'The optimized On/Off decisions must be in the file:',...
               '5minOpONOFFDec.xlsx'};
elseif EveryOP==2
    text27  = {'The optimized On/Off decisions must be in the file:',...
...
function varargout = ONOFF_OPDecisions_OutputFcn(hObject, eventdata, handles) 
...
save('ONOFF_OPDecisions');
close('ONOFF_OPDecisions');
