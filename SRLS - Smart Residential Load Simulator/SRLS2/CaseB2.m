function varargout = CaseB2(varargin)
% CASEB2 M-file for CaseB2.fig
%      CASEB2, by itself, creates a new CASEB2 or raises the existing
%      singleton*.
%
%      H = CASEB2 returns the handle to a new CASEB2 or the handle to
%      the existing singleton*.
%
%      CASEB2('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CASEB2.M with the given input arguments.
%
%      CASEB2('Property','Value',...) creates a new CASEB2 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before CaseB2_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to CaseB2_OpeningFcn via varargin.
%
...
%      insta
% Edit the above text to modify the response to help CaseB2

% Last Modified by GUIDE v2.5 30-Aug-2013 18:08:17

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @CaseB2_OpeningFcn, ...
                   'gui_OutputFcn',  @CaseB2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before CaseB2 is made visible.
function CaseB2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to CaseB2 (see VARARGIN)

% Choose default command line output for CaseB2
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes CaseB2 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = CaseB2_OutputFcn(hObject, eventdata, handles) 
