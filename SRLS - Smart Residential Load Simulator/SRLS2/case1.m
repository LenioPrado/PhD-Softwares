function varargout = case1(varargin)
% CASE1 M-file for case1.fig
%      CASE1, by itself, creates a new CASE1 or raises the existing
%      singleton*.
%
%      H = CASE1 returns the handle to a new CASE1 or the handle to
%      the existing singleton*.
%
%      CASE1('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CASE1.M with the given input arguments.
%
%      CASE1('Property','Value',...) creates a new CASE1 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before case1_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to case1_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help case1

% Last Modified by GUIDE v2.5 16-Feb-2014 21:08:19

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @case1_OpeningFcn, ...
                   'gui_OutputFcn',  @case1_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before case1 is made visible.
function case1_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to case1 (see VARARGIN)

% Choose default command line output for case1
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes case1 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = case1_OutputFcn(hObject, eventdata, handles) 
