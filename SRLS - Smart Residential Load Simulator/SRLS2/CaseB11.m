function varargout = CaseB11(varargin)
% CASEB11 M-file for CaseB11.fig
%      CASEB11, by itself, creates a new CASEB11 or raises the existing
%      singleton*.
%
%      H = CASEB11 returns the handle to a new CASEB11 or the handle to
%      the existing singleton*.
%
%      CASEB11('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in CASEB11.M with the given input arguments.
%
%      CASEB11('Property','Value',...) creates a new CASEB11 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before CaseB11_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to CaseB11_OpeningFcn via varargin.
%
...
%      insta
% Edit the above text to modify the response to help CaseB11

% Last Modified by GUIDE v2.5 24-Nov-2013 14:14:52

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @CaseB11_OpeningFcn, ...
                   'gui_OutputFcn',  @CaseB11_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before CaseB11 is made visible.
function CaseB11_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to CaseB11 (see VARARGIN)

% Choose default command line output for CaseB11
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes CaseB11 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = CaseB11_OutputFcn(hObject, eventdata, handles) 
